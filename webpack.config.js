...
const dapplets = fs.readdirSync(path.join(__dirname, "packages", "dapplets"));
...
module.exports = {
  ...
  entry: Object.fromEntries(
    dapplets.map((name) => [
      `packages/dapplets/${name}/build/index`,
      path.join(__dirname, `packages/dapplets/${name}/src/index.ts`),
    ])
  ),
  output: {
    path: __dirname,
